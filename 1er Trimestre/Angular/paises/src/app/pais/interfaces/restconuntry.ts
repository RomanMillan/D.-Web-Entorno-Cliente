...
//
//   const restcountry = Convert.toRestcountry(json);
//
...
export class Convert {
    public static toRestcountry(json: string): Restcountry[] {
        return cast(JSON.parse(json), a(r("Restcountry")));
    }

    public static restcountryToJson(value: Restcountry[]): string {
        return JSON.stringify(uncast(value, a(r("Restcountry"))), null, 2);
    }
}
